...
def login():
    ...
    if hasher.check_user(username, password):
...
def show_todo_app():
    ...
    def complete_task():
        try:
            ...
            tasks_listbox.delete(selected_task_index)
            completed_tasks_listbox.insert(tk.END, completed_task)
    ...
    task_frame = tk.Frame(window, bg="#333333")
    task_frame.pack(pady=10)

    task_label = tk.Label(task_frame, text="Enter a task:", bg="#333333", fg="#FFFFFF", font="Arial, 14")
    task_label.pack(pady=5)

    task_entry = tk.Entry(task_frame, width=30, font="Arial, 14")
    task_entry.pack(pady=5)

    add_task_button = tk.Button(task_frame, text="Add Task", width=15, command=add_task, font="Arial, 14")
    add_task_button.pack(pady=5)

    tasks_listbox = tk.Listbox(task_frame, width=50, height=10, font="Arial, 14")
    tasks_listbox.pack(pady=10)

    complete_task_button = tk.Button(task_frame, text="Complete Task", width=15, command=complete_task, font="Arial, 14")
    complete_task_button.pack(pady=5)

    completed_tasks_listbox = tk.Listbox(task_frame, width=50, height=10, font="Arial, 14")
    completed_tasks_listbox.pack(pady=10)

    delete_task_button = tk.Button(task_frame, text="Delete Task", width=15, command=delete_task, font="Arial, 14")
...
login_label = tk.Label(frame, text='TaskLogin', bg="#333333", fg="#c97c5d", font="Arial, 30")
username_label = tk.Label(frame, text='Username', bg="#333333", fg="#FFFFFF", font="Arial, 22")
username_entry = tk.Entry(frame, font="Arial, 22", bg="#FFFFFF")
password_label = tk.Label(frame, text='Password', bg="#333333", fg="#FFFFFF", font="Arial, 22")
password_entry = tk.Entry(frame, show="*", font="Arial, 22", bg="#FFFFFF")
login_button = tk.Button(frame, text="Login", bg="#333333", fg="#c97c5d", font="Arial, 30", command=login)
reset_button = tk.Button(frame, text="Reset", bg="#333333", fg="#c97c5d", font="Arial, 30", command=reset)
